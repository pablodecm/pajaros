...
save(redneuronal,file="redneuronal10.rda")
write.table(confmat_train,file="confmat_train10.txt")
write.table(confmat_test,file="confmat_test10.txt")
# library(doParallel)
