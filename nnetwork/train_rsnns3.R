...
save(redneuronal,file="redneuronal3.rda")
write.table(confmat_train,file="confmat_train3.txt")
write.table(confmat_test,file="confmat_test3.txt")
# library(doParallel)
