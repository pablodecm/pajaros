...
save(redneuronal,file="redneuronal1.rda")
write.table(confmat_train,file="confmat_train1.txt")
write.table(confmat_test,file="confmat_test1.txt")
# library(doParallel)
