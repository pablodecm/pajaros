...
save(redneuronal,file="redneuronal2.rda")
write.table(confmat_train,file="confmat_train2.txt")
write.table(confmat_test,file="confmat_test2.txt")
# library(doParallel)
