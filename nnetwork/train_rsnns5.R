...
save(redneuronal,file="redneuronal5.rda")
write.table(confmat_train,file="confmat_train5.txt")
write.table(confmat_test,file="confmat_test5.txt")
# library(doParallel)
