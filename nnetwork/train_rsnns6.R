...
redneuronal <- mlp(data$inputsTrain,data$targetsTrain,
                   size=c(100,200,200),maxit=50000,
...
save(redneuronal,file="redneuronal6.rda")
write.table(confmat_train,file="confmat_train6.txt")
write.table(confmat_test,file="confmat_test6.txt")
# library(doParallel)
